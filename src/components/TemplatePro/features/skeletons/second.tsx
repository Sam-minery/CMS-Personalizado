  ...
  return (
    <div className="h-full w-full flex items-center justify-center">
      <div
        ...
        className={cn(
          "max-w-[85%] group h-fit my-auto bg-neutral-100 dark:bg-neutral-900 w-full p-3 rounded-2xl border border-neutral-300 dark:border-neutral-700 shadow-2xl flex flex-col mask-radial-from-50% mask-b-from-50%",
