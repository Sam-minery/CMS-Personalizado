...
export const Banner3Block: Block = {
  slug: 'banner3',
  interfaceName: 'Banner3Block',
  labels: {
    singular: 'Banner 3 block',
    plural: 'Banner 3 blocks',
  },
  fields: [
    {
      name: 'content',
    ...
    },
    {
      ...
      admin: {
        description: 'Introduce un código de color HTML para el fondo de los botones (ej: #007BFF, #28A745, rgb(0,123,255), etc.)',
      },
    },
    {
      ...
      admin: {
        description: 'Introduce un código de color HTML para el texto de los botones (ej: #FFFFFF, #000000, rgb(255,255,255), etc.)',
      },
    },
    {
      name: 'fontFamily',
