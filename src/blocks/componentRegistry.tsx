/**
 * Registro de componentes de bloques para RenderBlocks.
 * Filtrado por projectConfig.enabledBlockSlugs.
 */
import type { ComponentType } from 'react'

import { enabledBlockSlugs } from '@/projectConfig'

import { ALL_BLOCK_SLUGS_ORDERED } from './configRegistry'

// eslint-disable-next-line @typescript-eslint/no-explicit-any -- block components have different prop types
type BlockComponentMap = Record<string, ComponentType<any>>
...
import { CTA1SendaAlterBlock as CTA1SendaAlterBlockComponent } from '@/blocks/CTA1_SENDA_Alter/Component'
...
import { LogoCloudTemplate } from '@/blocks/Logo_Cloud_Template/Component'
import { SpeedTemplate } from '@/blocks/Speed_Template/Component'
import { PricingTemplate } from '@/blocks/Pricing_Template/Component'
import { FAQTemplate } from '@/blocks/FAQ_Template/Component'
import { Feature1Template } from '@/blocks/Feature1_Template/Component'
import { Feature2Template } from '@/blocks/Feature2_Template/Component'
...
const BLOCK_COMPONENTS: BlockComponentMap = {
  ...
  cta1SendaAlter: CTA1SendaAlterBlockComponent,
  ...
  logo1: Logo1Block,
  logo2: Logo2Block,
  logoCloudTemplate: LogoCloudTemplate,
  speedTemplate: SpeedTemplate,
  pricingTemplate: PricingTemplate,
  faqTemplate: FAQTemplate,
  feature1Template: Feature1Template,
  feature2Template: Feature2Template,
  team1: Team1Block,
  team2: Team2Block,
...
/** Devuelve el mapa slug -> componente a usar en RenderBlocks (todos o solo habilitados) */
export function getBlockComponents(): BlockComponentMap {
  const slugs = enabledBlockSlugs ?? ALL_BLOCK_SLUGS_ORDERED
  const result: BlockComponentMap = {}
  for (const slug of slugs) {
    const Comp = BLOCK_COMPONENTS[slug]
    if (Comp) result[slug] = Comp
  }
  return result
}
