...
import type { Blog7BlockType } from "./config"
...
// Componente wrapper para Payload
export const Blog7Block: React.FC<Blog7BlockType> = (props) => {
  const { tagline, heading, description, featuredBlogPost, tabs, defaultValue } = props;
