...
export const sanitizeSVG = (svg: string | null | undefined): string => {
  ...
  return sanitizeHtml(svg, {
    ...
    // htmlparser2 normaliza nombres de atributos a minúsculas; incluir viewbox, preserveaspectratio, etc.
    allowedAttributes: {
      svg: ['viewbox', 'viewBox', 'width', 'height', 'xmlns', 'fill', 'stroke', 'class', 'aria-hidden', 'preserveaspectratio', 'preserveAspectRatio'],
      path: ['d', 'fill', 'stroke', 'strokewidth', 'strokeWidth', 'stroke-width', 'strokelinecap', 'strokeLinecap', 'stroke-linecap', 'strokelinejoin', 'strokeLinejoin', 'stroke-linejoin', 'transform', 'class'],
      circle: ['cx', 'cy', 'r', 'fill', 'stroke', 'strokewidth', 'stroke-width', 'class'],
      rect: ['x', 'y', 'width', 'height', 'rx', 'ry', 'fill', 'stroke', 'strokewidth', 'stroke-width', 'transform', 'class'],
      line: ['x1', 'y1', 'x2', 'y2', 'stroke', 'strokewidth', 'stroke-width', 'strokelinecap', 'stroke-linecap', 'class'],
      polyline: ['points', 'fill', 'stroke', 'strokewidth', 'stroke-width', 'class'],
      polygon: ['points', 'fill', 'stroke', 'strokewidth', 'stroke-width', 'class'],
      ellipse: ['cx', 'cy', 'rx', 'ry', 'fill', 'stroke', 'strokewidth', 'stroke-width', 'class'],
      ...
      clipPath: ['id'],
      mask: ['id'],
      pattern: ['id', 'x', 'y', 'width', 'height', 'patternunits', 'patternUnits', 'patterntransform', 'patternTransform'],
