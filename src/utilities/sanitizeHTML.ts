...
export const sanitizeSVG = (svg: string | null | undefined): string => {
  ...
  return sanitizeHtml(svg, {
    ...
    allowedAttributes: {
      svg: ['viewBox', 'width', 'height', 'xmlns', 'fill', 'stroke', 'class', 'aria-hidden', 'preserveAspectRatio'],
      path: ['d', 'fill', 'stroke', 'strokeWidth', 'stroke-width', 'strokeLinecap', 'stroke-linecap', 'strokeLinejoin', 'stroke-linejoin', 'transform', 'class'],
