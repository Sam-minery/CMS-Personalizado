...
export const Navbar1: React.FC<Navbar1Props> = (props) => {
  ...
  return (
    <section
      id="relume"
      className="z-[999] flex w-full items-center border-b border-gray-200 bg-white lg:min-h-18 lg:px-[5%]"
    >
      ...
      {isDropdownOpen && (
        <AnimatePresence>
          <motion.nav
            ...
            className="bg-white lg:absolute lg:z-50 lg:border lg:border-gray-200 lg:p-2 lg:[--y-close:25%]"
          >
