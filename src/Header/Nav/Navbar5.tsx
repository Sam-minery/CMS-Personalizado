...
type MegaMenuLink = {
  ...
  button?: {
    ...
    size?: 'sm' | 'primary' | null | undefined;
    variant?: 'primary' | 'secondary' | 'ghost' | 'link' | null | undefined;
  };
};
...
export const Navbar5: React.FC<Navbar5Props> = (props) => {
  ...
  return (
    <section
      id="relume"
      className="relative z-[999] flex w-full items-center justify-between border-b border-gray-200 bg-white lg:min-h-18 lg:px-[5%]"
    >
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 0.3 }}
        className="bottom-auto left-0 top-full w-full min-w-full max-w-full overflow-hidden bg-white lg:absolute lg:w-[100vw] lg:border-b lg:border-gray-200 lg:px-[5%] lg:[--height-close:auto]"
      >
        <div className="mx-auto flex size-full max-w-full items-center justify-between">
          <div className="w-full lg:flex">
            ...
            <div className="max-w-none relative flex flex-1 p-6 md:py-8 md:pl-8 md:pr-0 lg:max-w-md">
              ...
              <div className="absolute bottom-0 left-0 right-auto top-0 min-w-full bg-gray-50 lg:min-w-[100vw]" />
            </div>
          </div>
        </div>
      </motion.div>
